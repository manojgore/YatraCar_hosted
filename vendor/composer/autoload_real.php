...
class ComposerAutoloaderInit52be5826ac6b5f4570baab769a05ad01
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit52be5826ac6b5f4570baab769a05ad01::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire52be5826ac6b5f4570baab769a05ad01($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire52be5826ac6b5f4570baab769a05ad01($fileIdentifier, $file)
{
